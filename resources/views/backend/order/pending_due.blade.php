                    ...
                    <div class="card-body">         
                        <table id="basic-datatable" class="table dt-responsive wrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td> <img src="{{ asset($item->customer->image) }}" style="width:50px;"> </td>
                                    <td width="15%">{{ $item['customer']['name'] }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('order.details',$item->id) }}" class="btn btn-blue rounded-pill waves-effect waves-light"><i class="far fa-eye"></i></a>

                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#due-modal" id="{{ $item->id }}" onclick="orderDue(this.id)" ><i class="fab fa-amazon-pay"></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<div id="due-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
