                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h5 class="text-dark mt-1">Rp.<span data-plugin="counterup">{{ $total_paid }}</span></h5>
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h5 class="text-dark mt-1">Rp.<span data-plugin="counterup">{{ $total_due }}</span></h5>
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h5 class="text-dark mt-1"><span data-plugin="counterup">{{ count($completeorder) }}</span></h5>
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h5 class="text-dark mt-1"><span data-plugin="counterup">{{ count($pendingorder) }}</span></h3>
